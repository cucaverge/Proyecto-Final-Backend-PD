<?php
    if (!empty($_FILES['imagen_producto']['name'])) {
        $rutaImagen = 'imagen_producto/' . $_FILES['imagen_producto']['name'];
    ...
    if(!empty($_POST["nombre_producto"]) && !empty($_POST["descripcion_producto"])){
        ...
        $query = "INSERT INTO productos (nombre_producto, descripcion_producto, imagen_producto, id_producto, stock_producto, precio_producto) VALUES ('".$_POST['nombre_producto']."', '".$_POST['descripcion_producto']."', '".$rutaImagen."', '".$_POST['id_producto']."', '".$_POST['stock_producto']."', '".$_POST['precio_producto']."')";
    ...
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="alta" role="tabpanel" aria-labelledby="alta-tab">
                <form method="post" action="" id="altaForm" enctype="multipart/form-data">
